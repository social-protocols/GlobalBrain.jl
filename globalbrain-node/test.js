const { processVoteEventJsonC } = require('./index');
const fs = require('fs');
...
const voteEvent = '{"user_id":"100","tag_id":1,"parent_id":null,"post_id":1,"note_id":null,"vote":1,"vote_event_time":1708772663570,"vote_event_id":1}';
const result = processVoteEventJsonC(databasePath, voteEvent);
console.log(result);
...
// console.log(global_brain.process_vote_event_json(test_db_path, test_vote_event2));
//
...
// console.log(global_brain.process_vote_event_json(test_db_path, test_vote_event3));
//
// if (fs.existsSync(test_db_path)) {
// 	fs.unlinkSync(test_db_path);
// }
