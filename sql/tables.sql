...
create index if not exists ConditionalVote_tag_user_post on ConditionalVote(tag_id, user_id, post_id);
create index if not exists ConditionalVote_tag_user_post_note on ConditionalVote(tag_id, user_id, post_id, note_id);
