# # 3 posts: parent post and two children with opposite effects
# # -- all posts are posted
# # -- then people vote on A
# # -- then people vote on B and C
# # -- @test -> decide

# function opposite_effects(sim::SimulationAPI)
#     Random.seed!(3); 
