(sim::SimulationAPI) -> begin
    ...
    begin
        ...
        scores, _ = sim.step!(1, votes; description="Initially, the upvoteProbability on the video is $(initial_upvote_probability*100)%.")
    ...
    begin
        ...
        scores, _ = sim.step!(2, [votes_A; votes_B]; description="But among users who saw the comment proving the video isn't what it claims to be, the upvoteProbability falls to $upvote_probability_given_b.")
